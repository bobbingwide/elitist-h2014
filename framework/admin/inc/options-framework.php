...
function optionsframework_init() {
	...
	else if (file_exists( THEME_FRAMEWORK . '/admin' .'/options.php' ) ) {
		require_once THEME_FRAMEWORK . '/admin' . '/options.php';
	}
...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		...
		$of_page = add_menu_page(__('Theme Options', 'options_framework_theme'), THEME_NAME, 'edit_theme_options', 'options-framework','optionsframework_page');  //Option Page as an independient Menu
