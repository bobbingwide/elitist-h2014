...
if ( is_admin() ) {
	...
	//$of_page= 'appearance_page_options-framework';//This is if the Option Page is under "Appearance" Menu
	$of_page= 'toplevel_page_options-framework';//This is if the Option Page is top level Menu
