			...
			<div class="related-post-widget">
				...
				<?php
					...
					foreach($myposts as $post) : //loops through posts
						...
						?>
							<div class="related_post post_last">
						<?php
						}else{
						?>
						...
						?>
                            ...
                            <span></span>
                            <img src="<?php echo get_template_directory_uri(); ?>/framework/timthumb.php?src=<?php echo $thumbnail[0]; ?>&h=108&w=158&zc=1" alt="<?php the_title(); ?>" />
                            </a>
                            <?php
						}
							?>
